<div class="land" style="padding-top:30px;">
	<h1 style="font-size:60px;">Summary</h1>
	...
	{?>
			...
			<tr>
				<td colspan="2" style="font-size:25px; background: none;">
					<div class="shop_button" id="cart_1">
						<a><input type="submit" name="update_price" value="Update cart" /></a>
					</div>
				</td>
		...
		<div class="shop_button">
			<a href="index.php?view=order">Checkout</a>
		</div>
	<?php
	}
	else
		echo "<p align='center' style='color:#333;'>Your cart is empty 😢</p>";
	?>
</div>
